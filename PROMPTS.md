...
for classification and enrichment (low temperature = more deterministic, 
...
actionable — it directly feeds the escalation logic.
...
labeling, enrichment is about extraction. Combining them would make the 
...
The identifiers field is defined broadly on purpose — account IDs, invoice 
...
temperature produces more readable, human-feeling output without 
